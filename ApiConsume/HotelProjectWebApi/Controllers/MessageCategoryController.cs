...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class MessageCategoryController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddMessageCategory([FromBody] MessageCategory messageCategory)
        {
        ...
        [HttpDelete("{id}")]
        public IActionResult DeleteMessageCategory([FromRoute] int id)
        {
        ...
        [HttpGet("{id}")]
        public IActionResult GetMessageCategory([FromRoute] int id)
        {
            var value = _messageCategoryService.TGetById(id);
            return Ok(value);
        }
